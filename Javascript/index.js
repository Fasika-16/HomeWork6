...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    document.getElementById("submit").addEventListener("click", function () {
        ...
        userArray.push(new userObject (document.getElementById(" ID").value, document.getElementById("name").value, isLoginInfoCorrect
    ));
    ...
    $(document).bind("change", "#movieUser", function (event, ui) {
        isLoginInfoCorrect = document.getElementById("movieUser").value;
    });

// page before show code *************************************************************************
$(document).on("pagebeforeshow", "#LeaveMovieRev", function (event) {   
    createLeaveMovieRev();
});
});
function createLeaveMovieRev() {
    ...
    userArray.forEach(function (element,) {   // use handy array forEach method
        ...
        li.innerHTML = element.ID + " (" + element.name + "): " + element.password;
        newFont.appendChild(li);
    });
};
